...
export type CreateEmployeeMutation = (
  ...
  & { createEmployee: (
    { __typename?: 'Employee' }
    & Pick<Employee, 'id' | 'createdAt' | 'updatedAt' | 'username' | 'email'>
  ) }
);
...
export type EmployeesQuery = (
  ...
  & { employees: Array<(
    { __typename?: 'Employee' }
    & Pick<Employee, 'id' | 'email' | 'username'>
  )> }
);
...
export const UpdateEmployeeDocument = gql`
    mutation UpdateEmployee($input: EmployeeInput!, $id: Int!) {
